...
$pageIds = ['greeting','vision','purpose','organization','committee','history','ci','articles','directions','business','reform','operations','talent','safety','culture','welfare','faq','safety-proposal','members-only','terms','privacy','associations'];
