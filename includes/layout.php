...
$pageIds = ['greeting','vision','vision-1','vision-2','purpose','organization','committee','history','ci','articles','directions','business','reform','operations','talent','safety','culture','welfare','faq','press-tip','safety-proposal','members-only','terms','privacy','associations'];
