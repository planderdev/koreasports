...
export const courses = Array.from({length:8},(_,i)=>({...base(`course-${i+1}`,['스포츠 현장 안전교육','처음 시작하는 골프 레슨','생활체육 지도자 보수교육','펜싱 입문 클래스','자원봉사자 사전 안전교육','승마 기초와 안전수칙','풋살 팀워크와 기본기','지도자를 위한 응급 대응'][i],i%4===0?'안전교육':i===2?'보수교육':'레슨'),image:mediaAssets[i%4].image,alt:mediaAssets[i%4].alt,duration:'약 10분 · 3개 학습단계',format:'온라인',associationId:`assoc-${i%4+1}`,lessonIds:['lesson-1','lesson-2','lesson-3']}));
...
const copy = {
 ...
 qna:['무엇을 도와드릴까요?','Q&A 문의하기','궁금한 내용을 남겨주세요.'],
