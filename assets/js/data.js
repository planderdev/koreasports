...
export const navigationAll = [
 ...
 {title:'주요사업',english:'OUR BUSINESS',items:[page('주요사업','business'),{...link('대회·행사','/events.php'),children:[page('대회운영','operations'),link('대회참가신청','/events.php?status=접수중'),link('대회소식/공지','/board.php?category=대회공고'),link('현장갤러리','/board.php?category=포토·영상')]},hidden(page('문화예술 육성사업','culture')),hidden({...link('동호회 가입','/clubs.php'),children:[page('복지정책','welfare'),link('클럽/동호회 등록','/join.php?type=club')]})]},
