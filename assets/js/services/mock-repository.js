...
export function saveInquiry(category,payload={}){const s=state();s.inquiries.push({id:crypto.randomUUID(),title:payload.title||`${category} 문의`,body:payload.body||'',category,status:'접수',createdAt:new Date().toISOString()});write(s);}
